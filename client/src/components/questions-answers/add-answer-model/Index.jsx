  ...
  return (
    <div>
      <div className="addanswer">
        ...
        onClick={(e) => {
        openAddAnswerModal();
        console.log(question_body, question_id);
        // setId(question_id);
        // setBody(question_body);
        dispatch ({
    ...
    <Modal centered show={addAnswerModalIsOpen} onHide={closeAddAnswerModal} key={'AddAnswerModal' + clickedId }>
